    ...
    tiers: [
      {
        ...
        price: "One-time Setup Fee: ₹10,000",
        features: [
          "Monthly Fee: ₹1,800/month (₹21,600/year)",
          "Pages: 1–3 Pages",
          "Features: Next.js Framework, Basic CMS Integration, Monthly Updates, Bug Fixes",
      ...
      },
      {
        ...
        price: "One-time Setup Fee: ₹18,000",
        popular: true,
        features: [
          "Monthly Fee: ₹3,500/month (₹42,000/year)",
          "Pages: Up to 6 Pages",
          "Features: Advanced CMS, API Integrations, Hosting Setup, Priority Support",
          "Support: 1 Month Free Support",
        ],
        details: [],
      ...
      },
      {
        ...
        price: "One-time Setup Fee: ₹35,000+",
        features: [
          "Monthly Fee: ₹6,500–₹9,500/month",
          "Pages: 10+ Pages",
          "Features: High Performance Optimization, Advanced Security, AI Feature Integration, Admin Panel Development",
          "Support: 1 Month Free Support",
        ],
        details: [],
