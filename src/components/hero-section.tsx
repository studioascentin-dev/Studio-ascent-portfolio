    ...
    <section id="home" className="relative w-full min-h-screen flex items-center overflow-hidden">
      <div className="container mx-auto px-4 z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-center">
            {/* Combined Left and Right Content into a 2-column span for larger screens */}
            <motion.div
            ...
            <div className="hidden lg:flex items-end justify-center h-full">
                 <motion.div
                    ...
                    className="relative w-full h-[80vh] mt-auto"
                 >
                    <Image 
            ...
            <div className="lg:hidden md:col-span-2 flex items-center justify-center">
                 <motion.div
                    initial={{ opacity: 0, y: 100 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1, ease: 'easeOut' }}
