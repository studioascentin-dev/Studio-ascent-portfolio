...
const aboutDetails = [
    ...
    { icon: <BookOpen className="h-8 w-8 text-primary" />, title: "Studies", value: "K.V Digaru & Sonapur College", details: "I enjoy building a diverse range of websites, from sleek portfolios to complex e-commerce platforms. I completed my schooling from K.V Digaru and completed my secondary and my bachelor's degree from Sonapur College in 2025." },
