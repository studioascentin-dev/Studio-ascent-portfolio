...
const servicesData = {
  ...
  'ppt-design': {
    ...
    projects: [
        ...
        { name: 'Webinar Slides', image: 'https://placehold.co/600x450.png', pdf: '/webinar-slides.pdf', dataAiHint: 'tech webinar' },
        { name: 'Company Profile PPT', image: 'https://placehold.co/600x450.png', pdf: '/company-profile.pdf', dataAiHint: 'corporate deck' },
        { name: 'Product/Service Portfolio', image: 'https://placehold.co/600x450.png', pdf: '/product-portfolio.pdf', dataAiHint: 'product portfolio' },
        { name: 'Educational Lecture', image: 'https://placehold.co/600x450.png', pdf: '/educational-lecture.pdf', dataAiHint: 'lecture slides' },
    ]
  },
  'graphic-design': {
