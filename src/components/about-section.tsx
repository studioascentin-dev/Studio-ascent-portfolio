...
const aboutDetails = [
    ...
    { icon: <Heart className="h-8 w-8 text-primary" />, title: "Hobbies", value: "Travel & Exploring", details: "I like to travel and enjoy visiting new places, although I don't have any to do so 😂." },
